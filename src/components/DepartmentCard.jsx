...
const DepartmentCard = ({ onClose, onSave }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                onSave(data); // Pass the new department data to the parent component.
                onClose();
            } else {
                const errorData = await response.json();
                alert(`Error: ${errorData.message || 'Failed to create department'}`);
            }
        } catch (error) {
            alert('Network error: Failed to create department.');
        } finally {
            setIsLoading(false);
        }
    };
